        ...
        <form ref={formRef} action={formAction} className="space-y-8" key={state.resetKey}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Input name="legalName" id="legalName" placeholder="John Doe" required />
          ...
          <div className="space-y-2">
            ...
            <Input name="spotifyProfile" id="spotifyProfile" placeholder='or "N/A"' />
          ...
          <div className="space-y-2">
            ...
            <Input name="soundCloudLink" id="soundCloudLink" placeholder="https://soundcloud.com/..." />
          ...
          <div className="space-y-2">
            ...
            <Textarea name="assistanceDetails" id="assistanceDetails" placeholder="Drums, Clarity, Vocals..." required className="min-h-[120px]" />
          ...
          <div className="space-y-2">
            ...
            <Input name="songReference" id="songReference" placeholder="YouTube/Spotify/SoundCloud link" />
