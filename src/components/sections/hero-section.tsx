...
const IntroCard = ({ title, children, delay }: { title: string, children: React.ReactNode, delay: string }) => (
  <div
    className="liquid-glass liquid-glass-interactive rounded-xl p-6 animate-slide-in-from-bottom opacity-0"
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden text-center text-white pt-20">
      ...
      <div className="container relative z-10 px-4 sm:px-6 lg:px-8">
        <h1
          className="text-5xl sm:text-7xl lg:text-8xl font-black tracking-tighter uppercase text-glitch animate-slide-in-from-bottom opacity-0"
        ...
        <p 
            className="mt-4 max-w-3xl mx-auto text-lg sm:text-xl text-foreground/80 animate-slide-in-from-bottom opacity-0"
            style={{ animationDelay: '0.3s' }}
        >
          An ultra-modern music production studio specializing in phonk and related genres.
        </p>
        <div className="mt-8 animate-slide-in-from-bottom opacity-0" style={{ animationDelay: '0.5s' }}>
          <Button
            size="lg"
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
           <IntroCard title="Introduction" delay="0.7s">
          ...
          <IntroCard title="About Us" delay="0.9s">
